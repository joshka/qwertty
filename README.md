...
across chunks, preserve complete CSI input syntax, flush explicitly, and leave with reported
cleanup errors. It does not route terminal query responses yet.
